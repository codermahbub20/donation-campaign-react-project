...
const Banner = () => {
    ...
    return (
        <div>
            <div className="hero md:h-[70vh]" style={{ backgroundImage: 'url(https://i.ibb.co/G33QmwV/Rectangle-4281.png)' }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    ...
                    <button  className=" px-6 py-3 text-white bg-[#FF444A]">Search</button>
                    </div>
                </div>
            </div>
        </div>
